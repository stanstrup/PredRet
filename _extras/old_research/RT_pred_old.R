...
for (i in 1:nrow(comb_systems)){
  ...
  fits=loess.wrapper(rt1, rt2, span.vals = seq(0.2, 1, by = 0.05), folds = 10)
  fits_mono = monoproc(fits, bandwidth = 0.0001, mono1 = "increasing", gridsize=1000)
  
  
  plot(fits_mono)
  points(rt1,rt2,pch=20)
}
